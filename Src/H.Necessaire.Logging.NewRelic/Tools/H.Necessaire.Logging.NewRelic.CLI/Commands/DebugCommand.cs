...
namespace H.Necessaire.Logging.NewRelic.CLI.Commands
{
    internal class DebugCommand : CommandBase
    {
        public override async Task<OperationResult> Run()
        {
            ...
            await Logger.LogCritical("Critical Operation Exception", new OperationResultException(OperationResult.Fail("Failure Reason", "Failure Comment A", "Failure Comment B", "Failure Comment C")), new { PayloadA = "PayloadAValue" }, "NoteA".NoteAs("Note"));
